            ...
            <form className="mt-3" onSubmit={handleFormSubmission}>
              <div className="flex flex-col">
                ...
                <input
                  ...
                  onChange={(e) => {
                    handleInputChange(e);
                    // Custom validation logic for Gmail only
                    const emailRegex = /^[a-zA-Z0-9._%+-]+@gmail\.com$/;
                    if (!emailRegex.test(e.target.value)) {
                      e.target.setCustomValidity("Please enter a valid Gmail address.");
                    } else {
                      e.target.setCustomValidity(""); // Clear any previous custom validity message if valid
                    }
                  }}
                  className="rounded h-10 text-base pl-5 mb-3 border-x border-y border-gray-400"
